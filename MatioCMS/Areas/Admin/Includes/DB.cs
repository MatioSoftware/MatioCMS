...
namespace MatioCMS.Areas.Admin.Includes
{
    public class DB : Database.DB
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Admin>().Property("Passkey").IsUnicode(false);

            // adminstartpages
            modelBuilder.Entity<adminstartpage>().Property("Username").IsUnicode(false);
            modelBuilder.Entity<adminstartpage>().Property("WidgetName").IsUnicode(false);
